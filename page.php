						...
						<div class="row margin-top30">
                            <div class="blog-pagination">
								...
								?>
                                    ...
                                    <li class="active"><a href="page.php?page_id=<?php echo $pid=$page_id-1; ?>" ><i class="fa fa-long-arrow-left"></i></a></li>
                                    <?php
								}
									if($page_id!=22)
									{
									?>
                                    <li class="active"><a href="page.php?page_id=<?php echo $pid=$page_id+1; ?>"><i class="fa fa-long-arrow-right"></i></a></li>
									<?php
									}
									?>
