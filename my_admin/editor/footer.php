...
<script>
	$111(function(){
		$111('.Editor1').froalaEditor({
      height: 300
    });
		$111("a[href='https://www.froala.com/wysiwyg-editor?k=u']").remove();
	});
</script>

<script>
	$111(function(){
		$111('.Editorques').froalaEditor({
       toolbarButtons: ['undo', 'redo' , '|', 'bold', 'italic', 'underline', 'strikethrough', 'subscript', 'superscript','clearFormatting', 'html'],
