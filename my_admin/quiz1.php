			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>Quiz 1</h4></div>
					</div><!--.panel-heading-->
					...
					{
					?>
					<a href="add-question1.php" class="btn btn-success btn-ripple" >ADD QUESTION</a>
					<?php
					}
					?>
					...
					<table class="display datatables-basic table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="edit_quiz.php?ques_id=<?php echo $row_ques['ques_id'];?>" class="btn btn-success btn-ripple">EDIT</a>&nbsp;&nbsp;<a href="quiz1.php?delid=<?php echo $row_ques['ques_id'];?>" class="btn btn-success btn-ripple" style="background:red;border-color: red;" onclick="return confirm('Are you sure you want to Delete?')">DELETE</a></td>
