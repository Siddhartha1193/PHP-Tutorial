						...
						<form action="" class="form-horizontal" method="post" enctype="multipart/form-data" >
							<div class="form-content">
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<textarea class="Editorques" name="ans_1" required><?php echo htmlspecialchars($row_details['ans_1']); ?></textarea>
									</div>
								</div><!--.form-group-->
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<textarea class="Editorques" name="ans_2" required><?php echo htmlspecialchars($row_details['ans_2']); ?></textarea>
									</div>
								</div><!--.form-group-->
								...
								<div class="form-group">
									...
									<div class="col-md-7">
												...
												<textarea class="Editorques" name="ans_3" required><?php echo htmlspecialchars($row_details['ans_3']); ?></textarea>
								...
								<div class="form-group">
									...
									<div class="col-md-7">
											...
											<textarea class="Editorques" name="ans_4" required><?php echo htmlspecialchars($row_details['ans_4']); ?></textarea>
